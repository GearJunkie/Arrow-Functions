...
let joe = new Student('Joe Schmoe', 30, "Seattle");
...
// It is the object "joe = new Student": Arrow functions do not have a prototype property.

// 2. What is "this" when joe.scopeArrow() is invoked?
// It is the global window object, because there isn't a non-arrow function scope surrounding "this." Arrow functions retain the "this" value of the enclosing scope. Arrow functions do not have a prototype property.

// 3. Explain why "this" is different when an arrow function is used.
// An arrow function does not have its own bindings to "this and should not be used as methods. "this" is not reset within an arrow function, so the value of "this" is the same as the "this" of the enclosing scope.